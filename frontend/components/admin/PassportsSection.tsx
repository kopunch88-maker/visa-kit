      ...
      {passports.length > 0 && (
        <div className="border-t border-slate-200 pt-4 space-y-2">
          ...
          <p className="text-xs text-slate-500">
            <strong>Русские клиенты (РФ):</strong> если выбран внутренний
            паспорт РФ, он подставляется во ВСЕ русские документы — договор,
            акты, счета, выписку, письмо работодателя, CV, заключение
            техэкспертизы, командировочный приказ, трудовой договор,
            НПД-справку. Если внутренний не выбран — primary.
            <br />
            <strong>Иностранцы:</strong> выбор работает ТОЛЬКО для договора
            (договор может быть на исторический паспорт). Все остальные доки
            → primary.
            <br />
            <strong>Испанские формы (PDF)</strong> и <strong>апостиль</strong>
            — всегда primary независимо от выбора.
          </p>
        </div>
      )}
    </div>
