...
> **Дата последнего обновления:** 18.05.2026 — Pack 37.x — AI Document Audit (10 подпаков) + work_history sync в БД на 3-х путях изменения + passport_expiry_date через pipeline + ГОСТ-чек только info severity.
...
**Версия документа:** 4.0 (18.05.2026 — рефакторинг: убрано устаревшее, убраны дубли, добавлен Pack 37.x AI Document Audit полным блоком, обновлён список архитектурных подсистем §3, актуализирован роадмап §9).

**Базируется на:** 3.7 (16.05.2026 — Pack 36.0/36.1 + Инцидент 35 + Правило 58) ← 3.6 (Pack 35.x) ← 3.5 (Pack 33.x).
