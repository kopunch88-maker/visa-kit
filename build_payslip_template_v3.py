r"""
Pack 50.10-C-r3 — Генератор payslip_template.docx, точно по эталону.

Изменения r3 относительно r2:
  - Сжата шапка (уменьшены space_before/after параграфов)
  - Сплошная линия под "Долг предприятия..." (нижняя граница абзаца)
  - Пунктирная линия под "Общий облагаемый доход..." (dashed граница)
